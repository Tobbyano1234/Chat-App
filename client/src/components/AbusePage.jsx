...
const DepressedPage = () => {
    ...
    const CATEGORY = "Sexual Abuse";
    const TAGLINE = "Beaking free"
    const DB_CATEGORY = "Abuse";
                    ...
                    <div >
                        ...
                        </div>
                        {
                            ...
                            posts && posts.map((post, index) => {
                                ...
                                const { title, parent,  flagged, author_name, content, id, author_id, avatar, createdAt } = post;
