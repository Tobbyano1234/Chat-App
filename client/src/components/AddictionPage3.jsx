            ...
            <div className="media">
              <div className="media-body">
                ...
                <ul className="item-social">
                  <li>
                    <a href={`https://www.facebook.com/sharer/sharer.php?u=${ENDPOINT}`} target="_blank" rel="noopener" className="bg-fb">
          ...
          <div >
            ...
            </div>
            {
              ...
              posts && posts.map((post, index) => {
                ...
                const { title, parent, author_name, content, id, author_id, avatar, createdAt } = post;
                    ...
                    <div className="post-body">
                      ...
                      {/* <div className="post-meta-wrap">
                        <div className="post-meta">
                          <div className="meta-text"><a onClick={handleShowReplies} id={"meta_replies-" + index} data-id={id}>2 Replies </a></div>
                        </div>
                      </div> */}
