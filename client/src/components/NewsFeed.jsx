...
const NewsFeed = () => {
    ...
    const CATEGORY = `${firstName}'s News Feed`;
    const DB_CATEGORY = "NEWSFEED";
    const TAGLINE = "Catch up with the latest. All in one place"
    ...
    const getUsers = async () => {
        try {
            const res = await mainAxios.get("users/all")
    ...
    const getPosts = async () => {
        try {
            const res = await mainAxios.post("notes/all", {
                category: DB_CATEGORY
            })
    ...
    return (
        ...
        <div>
            ...
            <div className="container forum-container">
                <div className="banner-user banner-forum banner-newsfeed">
                    ...
                    <div >
                        ...
                        </div>
                        {
                            ...
                            posts && posts.map((post, index) => {
                                ...
                                const { title, category, flagged, parent, author_name, content, id, author_id, avatar, createdAt } = post;

                                return (
                                    parent === '0' && category !== "REPORT" && 
                                                ...
                                                <div className="media-body ">
                                                    ...
                                                    <ul className="entry-meta">
                                                        <li className="meta-privacy">
                                                            <i className="icofont-world"></i> {category}
                                                        </li>
